        ...
        <div class="blueBody">
            ...
            <div id="editAndGantiPassword">
                <div id="editProfileBox">
                    <h3>Edit Profile</h3>
                    <form action="/partisipan/prosesEditProfil" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <input type="hidden" name="role" value="Partisipan">
                        <input type="submit" class="btn btnDarkBlue" value="Edit Profil">
                    </form>
                </div>
                <div id="gantiPasswordBox">
                <h3>Ganti Password</h3>
                    <form action="/partisipan/gantiPassword" method="POST">
                        @csrf
                        <div class="formElement">
